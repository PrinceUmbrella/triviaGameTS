...
function Game() {
  ...
  const levelThree: Question[] = shuffleArray(getLevelQuestion(allQuestion, 3));
  const levelFour: Question[] = shuffleArray(getLevelQuestion(allQuestion, 4));
  const levelFive: Question[] = shuffleArray(getLevelQuestion(allQuestion, 5));
